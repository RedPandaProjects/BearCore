...
namespace BearCore
{
	...
	public:
		...
		void writeString(const BearString&base,Encoding::Encoding encoding,bool info=true);
		void writeStringWithZero(const BearString&base, Encoding::Encoding encoding);
		void writeStringAndNewLine(const BearString &str, Encoding::Encoding encoding);
