...
int64 BearCore::BearMemoryStream::seek(bsize tell) const
{
	if (size() < 0)return -1;
...
int64 BearCore::BearMemoryStream::tell() const
{
	return m_tell;
}

int64 BearCore::BearMemoryStream::size() const
{
	return m_size;
}
...
BearCore::BearStreamPtr< BearCore::BearBufferedReader> BearCore::BearMemoryStream::readChunkAsBufferedReader(uint32 type) const
{
