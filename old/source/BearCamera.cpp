...
BearCore::BearCamera::BearCamera()
{
	SetPosition(0, 0, 0);
	SetRotation(0, 0, 0);
}
# define PI           3.14159265358979323846f /* pi */
void BearCore::BearCamera::SetPosition(BearVector3<float> pox)
{
	m_position = pox;
}

void BearCore::BearCamera::SetRotation(BearVector3<float> rot)
{
	m_rotation = rot;
}

void BearCore::BearCamera::SetPosition(float x, float y, float z)
{
	m_position.set(x, y, z);
}

void BearCore::BearCamera::SetRotation(float x, float y, float z)
{
	m_rotation.set(x, y, z);
}

void BearCore::BearCamera::AddPosition(BearVector3<float> pox)
{
	m_position += pox;
}

void BearCore::BearCamera::AddRotation(BearVector3<float> rot)
{
	m_rotation += rot;
...
void BearCore::BearCamera::AddPosition(float x, float y, float z)
{
	AddPosition(BearVector3<float>(x, y, z));
}

void BearCore::BearCamera::AddRotation(float x, float y, float z)
{
	AddRotation(BearVector3<float>(x, y, z));
}

BearCore::BearVector3<float>& BearCore::BearCamera::GetRotation()
{
	return m_rotation;
}

const BearCore::BearVector3<float>& BearCore::BearCamera::GetRotation() const
{
	return m_rotation;
}
...
void BearCore::BearCamera::Render()
{
...
void BearCore::BearCamera::Swap(BearCamera & right)
{
...
BearCore::BearCamera::BearCamera(const BearCamera & right)
{
	Copy(right);
}

BearCore::BearCamera & BearCore::BearCamera::operator=(const BearCamera & right)
{
	Copy(right);
	return *this;
}

BearCore::BearCamera::BearCamera(BearCamera && right)
{
	Swap(right);
}

BearCamera & BearCore::BearCamera::operator=(BearCamera && right)
{
	Swap(right);
	return *this;
}
