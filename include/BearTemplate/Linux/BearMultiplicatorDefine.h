...
#define BEAR_IFF(args) BEAR_IF_I ## args
#define BEAR_IF(bool_,text,text1) BEAR_IFF((bool_,text,text1))

//���� ������ 0 �� , ����� ������
#define BEAR_IF_COMMA_I(count) BEAR_IF(BEAR_TO_BOOL(count),BEAR_COMMA,BEAR_NIL)
#define BEAR_IF_COMMAA(count) BEAR_IF_COMMA_I ## count
#define BEAR_IF_COMMA(count) BEAR_IF_COMMAA_I((count))

//�������� ��������� ����� ������� param0,param1,... BEAR_ENUM_PARAMS(����������,���_��������)
...
#define BEAR_REPEAT_1(parm,text)  parm ## args
