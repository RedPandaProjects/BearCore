...
#ifdef WINDOWS
BEARTOOL_API BearCore::BearMap<int32, int32>* LToWinowsKey=0;
BEARTOOL_API BearCore::BearMap<int32, int32> *GFromWinowsKey=0;
static void RegisterWindowsKey(int32 win, BearCore::BearInput::Key key)
{
...
{
	BearCore::bear_delete(LToWinowsKey);
	BearCore::bear_delete(GFromWinowsKey);
}
void GKeyWindowsInitialize()
{
	LToWinowsKey = BearCore::bear_new<BearCore::BearMap<int32, int32>>();
	GFromWinowsKey = BearCore::bear_new<BearCore::BearMap<int32, int32>>();
