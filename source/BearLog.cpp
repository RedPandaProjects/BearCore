...
#include "BugTrap.h"
#endif
BearVector<BearString> *LogData=0;
static BearMutex LogMutex;
static BearLogCallBack LogCallBack=0;
...
BearLogCallBack BearLog::SetCallBack(BearLogCallBack call_back)
{
	auto temp = LogCallBack;
	LogCallBack = call_back;
	return temp;
}

const BearVector<BearString>& BearLog::Lock()
{
	LogMutex.Lock();
	return *LogData;
}
